...
class UnsupBipartiteGraphsage : public ModelZooImpl {
 private:
  int depth_ = 1;
  int dim_ = 128;
 ...
 public:
  DEFINE_MODEL_ZOO_LIKE(UnsupBipartiteGraphsage);
...
MODEL_ZOO_REGISTER(UnsupBipartiteGraphsage, "UnsupBipartiteGraphSage");
MODEL_ZOO_REGISTER(UnsupBipartiteGraphsage, "unsup_bipartite_graphsage");
